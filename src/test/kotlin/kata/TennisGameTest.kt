...
class TennisGameTest {
    ...
    fun `increasing the score when a player wins a point`() =
        listOf(
            ...
            Triple(2, 3, "30-40"),
            Triple(3, 3, "Deuce"),
            Triple(4, 3, "Advantage player one"),
            Triple(3, 4, "Advantage player two"),
            Triple(4, 4, "Deuce"),
            Triple(5, 4, "Advantage player one"),
            Triple(4, 5, "Advantage player two"),
            Triple(4, 0, "Player one wins"),
            Triple(0, 4, "Player two wins"),
            Triple(3, 5, "Player two wins"),
